...
2. Labeling with an LLM each parser extracted skill as either a **hard skill or a soft skill**. <br>  🔗 [See the Hard Soft skills labelling notebook](../hiring_cv_bias/hard_soft_skills_labelling/hard_soft_skill_labelling.html)   
